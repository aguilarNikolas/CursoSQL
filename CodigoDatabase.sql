...
/* CONECTANDO-SE AO BANCO - TRABALHANDO DENTRO DO bd*/
...
/* DIFERENÇA ENTRE (CHAR(10) E VARCHAR(10))
CHAR(10) - ELE SEPARA 10 BYTES PARA INFORMAÇÕES DE FORMA FIXA, SE ENTRAR SÓ 4 LETRAS O RESTANTE ENTRA COMO ESPAÇO VAZIO,
SERÁ CONSIDERADO 10 BYTES

VARCHAR(10) - ELE SEPARA 10 BYTES DE INFORMAÇÃO DE FORMA DINÂMICA, SE ENTRAR SÓ 4 LETRAS, SERÁ CONSIDERADO 4 BYTES


O CHAR É MAIS RÁPIDO, MAS DEVE-SE SABER EXATAMENTE O TAMANHO QUE PRECISA
*/


/*VERIFICANDO AS TABELAS NO BD */
...
INSERT INTO CLIENTE(NOME,SEXO,ENDERECO,TELEFONE,CPF) VALUES('JAO','M','RUA BLABLABLA - COPACABANA - RJ','3335-5045',12345671211);

INSERT INTO CLIENTE(NOME,SEXO,ENDERECO,TELEFONE,CPF) VALUES('MARIA','F','RUA CREDO - MOCA - SP','3225-5045',11111111111);

INSERT INTO CLIENTE(NOME,SEXO,ENDERECO,TELEFONE,CPF) VALUES('PEDRO','M','RUA BIROLIRO - PILARZINHO - PR','3316-5045',22222222222);

INSERT INTO CLIENTE(NOME,SEXO,ENDERECO,TELEFONE,CPF) VALUES('ANITA','F','RUA BANDIDA - MEIA PRAIA - SC','3115-5045',33333333333);

/* O COMNADO SELECT 

SELEÇÃO, PROJEÇÃO E JUNÇÃO 

PROJEÇÃO = O QUE VOCÊ PRECISA VER

PROJETAR COISAS QUE EXISTEM E QUE NÃO EXISTEM 

SELECT NOW() AS DATA_HORA;  - ALIAS PARA A COLUNA
*/

/* SELECT É PROJETAR - FILTRO DE COLUNA*/

SELECT NOME AS CLIENTE, SEXO,EMAIL, NOW() AS DATA_HORA FROM CLIENTE;


/* SÓ PARA AMBIENTE ACADÊMICO - ELE RETORNA UM FULL REQUEST, DIMINUI A EFICIÊNCIA DO BANCO */
SELECT * FROM CLIENTE;



/* WHERE É PARA SELEÇÃO - FILTRANDO EM NÍVEL DE LINHA */

SELECT NOME FROM CLIENTE WHERE SEXO = 'F'
 
 
/* LIKE - PESQUISAR ALGO TRATANDO POR APROXIMAÇÃO 
TRABALHA COM CARACTAR CORINGA (%) - SIGNIFICA QUALQUER COISA
*/ 
/* '%RJ' - SIGNIFICA, QUALQUER COISA QUE VENHA ANTES DE RJ */
SELECT NOME, EMAIL FROM CLIENTE WHERE ENDERECO LIKE 'RUA%';



------------------------------------------------------------------------------

/* EXERCÍCIO DE FIXAÇÃO LIVRARIA */
...
/* EXERCICIO TABELA VERDADE / OPERADORES LOGICOS - OR , AND */	
...
SELECT SEXO_DO_AUTOR, COUNT(*) AS 'QUANTIDADES' FROM LIVROS GROUP BY SEXO_DO_AUTOR;

/* PARA MELHORAR O DESEMPENHO DA BD

CONDICAO
70% MULHERES
30% MORA NO RJ

SE USAR O OPERADOR - OR - COLOCAR A MAIOR PORCENTAGEM NA FRENTE 'WHERE SEXO='F' OR CIDADE = 'RJ''
SE USAR O OPERADOR - AND - COLOAR A MENOR PORCENTAGEM NA FRENTE 'WHERE CIDADE= 'RJ' AND SEXO='F''
...
-O GESTOR DE MKT PEDIU A LISTA DAS FUNCIONARIAS (AS = FEMININO) QUE TRABALHEM NO DEPARTAMENTO DE FILMES OU NO DEPARTAMENTO LAR.
ELE PRECISA MANDAR UM EMAIL PARA AS COLABORADORAS DOS SETORES

-COMO ESTAMOS TRABALHANDO COM (AND), COLOCAMOS O DEPARTAMENTO PRIMEIRO, POIS ELE IRA CHECAR A SEGUNDA CONDIÇÃO UM NUMERO MENOR DE VEZES

-TRAGA OS FUNCIONARIOS DO SECO MASCULINO OU OS FUNCIONARIOS QUE TRABALHEM NO JARDIM
...
SELECT COUNT(*) FROM FUNCIONARIOS WHERE DEPARTAMENTO = 'FILMES';  -- 21 CASOS
SELECT COUNT(*) FROM FUNCIONARIOS WHERE DEPARTAMENTO = 'ROUPAS';  -- 53 CASOS
SELECT COUNT(*), DEPARTAMENTO FROM FUNCIONARIOS GROUP BY DEPARTAMENTO ORDER BY 1; -- ORDENADO EM ORDEM CRESCENTE PELA PRIMEIRA COLUNA
...
--TRAGA OS FUNCIONARIOS (OS = MASCULINO) QUE TRABALHAM NO DEPARTAMENTO DE FILMES (OU) NO DEPARTAMENTO DE ROUPAS
-- 74 FUNCIONARIOS
SELECT * FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'ROUPAS' OR DEPARTAMENTO = 'FILMES');


--O GESTOR DE MKT PEDIU A LISTA DAS FUNCIONARIAS (AS = FEMININO) QUE TRABALHEM NO DEPARTAMENTO DE FILMES OU NO DEPARTAMENTO LAR. ELE PRECISA MANDAR UM EMAIL PARA AS COLABORADORAS DOS SETORES
-- FILMES= 23, LAR = 52 - ENTÃO LAR VEM ANTES
-- 41 MULHERES
...
SELECT COUNT(*), DEPARTAMENTO FROM FUNCIONARIOS WHERE DEPARTAMENTO='JARDIM'; -- 47 PESSOAS
SELECT COUNT(*), SEXO FROM FUNCIONARIOS GROUP BY SEXO ORDER BY 1; --484 HOMENS
SELECT COUNT(*) FROM FUNCIONARIOS WHERE SEXO='MASCULINO' OR  DEPARTAMENTO='JARDIM'; --507 PESSOAS
SELECT * FROM FUNCIONARIOS WHERE SEXO='MASCULINO' OR  DEPARTAMENTO='JARDIM';

-----------------------------------------------------------------------------------------------


/* FILTRNADO VALORES NULOS */
...
SELECT * FROM FUNCIONARIOS WHERE EMAIL IS NULL; -- SE É NULL

SELECT * FROM FUNCIONARIOS WHERE EMAIL IS NOT NULL; -- SE NÃO É NULL



/* CLAUSULA UPDATE 
WHERE - É O COMANDO MAIS IMPORTANTE PARA O UPDATE E O DELETE
*/
...
UPDATE CLIENTE 
SET EMAIL= 'JAO.DA.SILVA@GMAIL.COM'
WHERE NOME='JAO';
...
/* CLÁUSULA DELETE 
SEMPRE USAR -- WHERE --
SEMPRE FAÇA UM - COUNT(*) - ANTES DE VOCE DELETAR ALGO!!
*/

SELECT * FROM CLIENTE;
SELECT COUNT(*) FROM CLIENTE; 
SELECT COUNT(*) FROM CLIENTE WHERE NOME='JAO'; -- 3 OCORRENCIAS
SELECT * FROM CLIENTE WHERE NOME='JAO';

DELETE FROM CLIENTE
WHERE NOME='JAO'; -- DEVE TER 3 OCORRENCIAS

SELECT COUNT(*), NOME FROM CLIENTE GROUP BY NOME;  -- CLIENTES DUPLICADOS 


-- ALGUMAS VEZES PODE TER MAIS DE UM CLIENTE COM O MESMO NOME, PRESTAR ATENÇÃO
--VERIFICAR COM -SELECT- ANTES DE FAZER CAGADA
DELETE FROM CLIENTE 
WHERE NOME='MARIA'
OR EMAIL= 'MARIA@GMAIL.COM';  -- OR - TRAZ TODO MUNDO COM PELO MENOS UMA DAS COPNDIÇÕES

SELECT * FROM CLIENTE  
WHERE NOME='MARIA'
AND EMAIL= 'MARIA@GMAIL.COM'  -- AND -  TRAZ TODO MUNDO QUE SATISFAÇA AS DUAS CONDIÇÕES
...
quem define a cardinalidade é a sua regra de negócio
exemplo: o gestor na modelagem pediu
-endereço: obrigatório o cadastro de um endereço(no MÀXIMO 1).- par OBRIGATORIEDADE E CARDINALIDADE (1,1)
-telefone: o cliente não é obrigado a informar telefone, porém, caso queira, ele pode informar MAIS de um. - par OBRIGATORIEDADE E CARDINALIDADE (0,n)




(0,n) - par OBRIGATORIEDADE E CARDINALIDADE. OBRIGATORIEDADE pode ser 0 (não obrigatório) e 1 (obrigatório). CARDINALIDADE pode ser 1 ou mais de 1 (n)
OBRIGATORIEDADE -> se vai acontecer ou não
CARDINALIDADE -> trata do máximos de ocorrências
*/

/* PRIMEIRA FORMA NORMAL 

- PRIMEIRA REGRA: TODO CAMPO VETORIZADO (ARRAY) SE TORNARÁ OUTRA TABELA.  -- SÃO DA "MESMA FAMILIA"
[AMARELO, AZUL,LARANJA, VERDE] -> CORES 
[KA,FIESTA, UNO, CIVIC] -> CARROS



-SEGUNDA REGRA: TODO CAMPO MULTIVALORADO SE TORNARÁ OUTRA TABELA,
 OU QUANDO O CAMPO FOR DIVISÍVEL
 
 ENDEREÇO -> PADRE AGOSTINHO - BIGORRILHO - CURITIBA - PR
 TEM QUE VIRAR OUTRA TABELA.
 
 
 
- TODA TABELA NECESSITA DE PELO MENOS 1 CAMPO QUE IDENTIFIQUE TODO O REGISTRO COMO SENDO ÚNICO.
CHAMAMOS ISSO DE CHAVE PRIMÁRIA OU PRIMARY KEY.  
...
DROP TABLE CLIENTE; -- PARA APAGAR TABELA

CREATE TABLE CLIENTE(
	IDCLIENTE INT PRIMARY KEY AUTO_INCREMENT,
	NOME VARCHAR(30) NOT NULL,
	SEXO ENUM('M','F') NOT NULL,	-- ENUM SÓ EXISTE NO MYSQL
	EMAIL VARCHAR(50) UNIQUE,  -- O EMAIL É UNICO MAS NÃO PODE SER DEIXADO EM BRANCO
...
CREATE TABLE ENDERECO(
	...
	ID_CLIENTE INT UNIQUE, -- O TIPO TEM QUE SER IGUAL À PRIMARY KEY
...
CADSATRO DE MAIS DE UM. (OPCIONAL)
...
/* EM RELACIONAMENTOS 1X1 A CHAVE ESTRANGEIRA FICA NA TABELA MAIS FRACA (CONFIGURAÇÃO DE FORÇA DEPENDE DA REGRA DE NEGÓCIO) */
/* EM RELACIONAMENTOS 1XN A CHAVE ESTRANGEIRA FICA NA CARDINALIDADE N*/





insert into cliente values (NULL,'Joao','M','JOAO@IG.COM','938599210'); -- no MySql voce tem que indentificar no campo da Primary Key, NULL - para autoincrementar
insert into cliente values (NULL,'CARLOS','M','CARLOS@IG.COM','75746747');
insert into cliente values (NULL,'Ana','F','Ana@IG.COM','2464266356');
insert into cliente values (NULL,'Clara','F','NULL','3575757734');
insert into cliente values (NULL,'JORGE','M','JORGE@IG.COM','73732577');
insert into cliente values (NULL,'Celia','F','Celia@IG.COM','73737376373');	
...
+-----------+--------+------+---------------+-------------+
|         1 | Joao   | M    | JOAO@IG.COM   | 938599210   |
|         2 | CARLOS | M    | CARLOS@IG.COM | 75746747    |
|         3 | Ana    | F    | Ana@IG.COM    | 2464266356  |
|         4 | Clara  | F    | NULL          | 3575757734  |
|         5 | JORGE  | M    | JORGE@IG.COM  | 73732577    |
|         6 | Celia  | F    | Celia@IG.COM  | 73737376373 |
+-----------+--------+------+---------------+-------------+


INSERT INTO ENDERECO VALUES(NULL,'RUA ANTONIO SA','CENTRO','B.HORIZONTE','MG',4);
INSERT INTO ENDERECO VALUES(NULL,'RUA CAPITAO Hermes','CENTRO','RIO DE JANEIRO','RJ',1);
INSERT INTO ENDERECO VALUES(NULL,'RUA PRESIDDENTE VARGAS','JARDINS','SAO PAULO','SP',3);
INSERT INTO ENDERECO VALUES(NULL,'RUA ALFANDEGA','ESTACIO','RIO DE JANEIRO','RJ',2);
INSERT INTO ENDERECO VALUES(NULL,'RUA DO OUVIDOR','FLAMENGO','RIO DE JANEIRO','RJ',6);
INSERT INTO ENDERECO VALUES(NULL,'RUA URIGUAIANA','CENTRO','VITORIA','ES',5);


INSERT INTO TELEFONE VALUES(NULL,'CEL', '025285202', 5);
INSERT INTO TELEFONE VALUES(NULL,'RES', '354863431', 5);
INSERT INTO TELEFONE VALUES(NULL,'CEL', '763737373', 1);
INSERT INTO TELEFONE VALUES(NULL,'COM', '737378327', 2);
INSERT INTO TELEFONE VALUES(NULL,'RES', '737527369', 1);
INSERT INTO TELEFONE VALUES(NULL,'CEL', '737568757', 3);
INSERT INTO TELEFONE VALUES(NULL,'CEL', '368993639', 5);
INSERT INTO TELEFONE VALUES(NULL,'COM', '123433532', 1);
INSERT INTO TELEFONE VALUES(NULL,'RES', '963432397', 5);
INSERT INTO TELEFONE VALUES(NULL,'CEL', '796733938', 2);
...
--QUANDO PEDEM UMA QUERY, PRIMEIRO COMEÇA PROJETANDO

-- PROJEÇÃO -> TUDO QUE VAI SER MOSTRADO NA TELA, PODE VIR DE TABELA, PROGRAMADA OU FUNÇÃO
SELECT * FROM TABELA;
SELECT NOW() AS DATA_ATUAL;
SELECT 2+2 AS SOMA;


--SELEÇÃO -> FILTRAR, TRAZER UM SUBCONJUNTO DE UM CONJUNTO TOTAL DE REGISTROS DE UMA TABELA. A CLÁUSULA DE SELEÇÃO É O WHERE.
...
WHERE IDCLIENTE=ID_CLIENTE;  -- ESTOU USANDO O 'WHERE' COMO JOIN (ESTÁ ERRADO ISSO). WHERE É CLAUSULA DE SELEÇÃO
...
/*QUERY COMPLETA - PROJEÇÃO,ORIGEM, JUNÇÃO, SELEÇÃO*/
SELECT NOME,SEXO,BAIRRO,CIDADE
FROM CLIENTE 
	INNER JOIN ENDERECO  
	ON IDCLIENTE=ID_CLIENTE
...
--COLOCO A TABELA DE ONDE VEM CADA COISA COLOCANDO OS OBJETOS CERTOS SEM DAR ERRO EM COLUNA
...
| NOME   | SEXO | BAIRRO  | CIDADE         | TIPO | NUMERO    |
+--------+------+---------+----------------+------+-----------+
| Ana    | F    | JARDINS | SAO PAULO      | CEL  | 737568757 |
| CARLOS | M    | ESTACIO | RIO DE JANEIRO | COM  | 737378327 |
| CARLOS | M    | ESTACIO | RIO DE JANEIRO | CEL  | 796733938 |
| JORGE  | M    | CENTRO  | VITORIA        | CEL  | 025285202 |
| JORGE  | M    | CENTRO  | VITORIA        | RES  | 354863431 |
| JORGE  | M    | CENTRO  | VITORIA        | CEL  | 368993639 |
| JORGE  | M    | CENTRO  | VITORIA        | RES  | 963432397 |
| Joao   | M    | CENTRO  | RIO DE JANEIRO | CEL  | 763737373 |
| Joao   | M    | CENTRO  | RIO DE JANEIRO | RES  | 737527369 |
| Joao   | M    | CENTRO  | RIO DE JANEIRO | COM  | 123433532 |
+--------+------+---------+----------------+------+-----------+
...
/*
	...
	DCL - DATA CONTROL LANGUAGE (CONTROLE DE ACESSO AOS DADOS ATRAVÉS DE USUÁRIOS)
	TCL - TRANSACTION CONTROL LANGUAGE (CONTROLE DE TRANSAÇÃO, PASSA PELA ATOMICIDADE DOS BANCOS)
...
/* ALTER TABLE */
/* ALTERANDO UM NOME DE UMA COLUNA - CHANGE */
...
/*ADICIONANDO UMA COLUNA NA ORDEM ESPECIFICA - DEPOIS*/
ALTER TABLE PRODUTO
ADD COLUMN PESO FLOAT(10,2) NOT NULL
AFTER NOME_PRODUTO;

/*ADICIONANDO UMA COLUNA NA ORDEM ESPECIFICA - PRIMEIRA*/
ALTER TABLE PRODUTO
ADD COLUMN PESO FLOAT(10,2) NOT NULL
FIRST;
...
SELECT CLIENTE.IDCLIENTE, CLIENTE.EMAIL, CLIENTE.SEXO, CLIENTE.EMAIL,
...
SELECT CLIENTE.IDCLIENTE, CLIENTE.EMAIL, CLIENTE.SEXO,
		ENDERECO.BAIRRO, ENDERECO.ESTADO,
		TELEFONE.TIPO
	FROM CLIENTE
	INNER JOIN ENDERECO
...
| NOME    | EMAIL             | NUMERO    | ESTADO |
+---------+-------------------+-----------+--------+
| JORGE   | JORGE@IG.COM      | 025285202 | ES     |
| JORGE   | JORGE@IG.COM      | 354863431 | ES     |
| Joao    | JOAO@IG.COM       | 763737373 | RJ     |
| CARLOS  | CARLOS@IG.COM     | 737378327 | RJ     |
| Joao    | JOAO@IG.COM       | 737527369 | RJ     |
| Ana     | Ana@IG.COM        | 737568757 | SP     |
| JORGE   | JORGE@IG.COM      | 368993639 | ES     |
| Joao    | JOAO@IG.COM       | 123433532 | RJ     |
| JORGE   | JORGE@IG.COM      | 963432397 | ES     |
| CARLOS  | CARLOS@IG.COM     | 796733938 | RJ     |
...
/* VIEW - ELA JÁ ATRELA UMA QUERY AO OBJETO ESCOLHIDO*/
...
SHOW TABLES; -- AS VIEWS SÃO CRIADAS NAS TABLES, É UMA TABELA VIRTUAL
SHOW DATABASES;
...
--CRIANDO UM PREFIXO PARA AS TABLES VIEWS

CREATE VIEW V_RELATORIO AS 
SELECT 	CLIENTE.NOME,
		CLIENTE.SEXO,
		IFNULL(CLIENTE.EMAIL,'*********') AS 'E-MAIL',
		TELEFONE.TIPO, 
		TELEFONE.NUMERO,
		ENDERECO.BAIRRO, 
		ENDERECO.CIDADE, 
...
/* UPDATE, INSERT, DELETE*/ -- NÃO CONSIGO FAZER DELETE NEM INSERT EM VIEW COM 'JOIN'
--É PERMITIDO FAZER UPDATE EM VIEW ** CUIDADO POIS MODIFICA A TABLE ORIGINAL**
...
DELETE FROM V_RELATORIO WHERE NOME='JOSE';
ERROR 1395 (HY000): Can not delete from join view 'comercio.v_relatorio'


-- CONSIGO FAZER SELEÇÃO EM VIEW
SELECT * FROM V_RELATORIO
WHERE SEXO = 'F';
...
ORDER BY 1,2; -- ERROR 1054 (42S22): Unknown column '2' in 'order clause'

SELECT NOME FROM ALUNOS
ORDER BY NUMERO, NOME;


/*ORDER BY DESC / ASC */ -- ASCENDENTE E DESCENDENTE
SELECT * FROM ALUNOS
ORDER BY 1 ASC; 
...
/* inicio aula do PostrgreSQL --------------------------

*/

SHOW DATESTYLE;  -- DD/MM/AAAA

-- funções de agregação

select count(salario), cargo from funcionarios
group by cargo;

-- GROUP BY SEXO
SELECT COUNT(SEXO) AS "QDE DE CADA SEXO", SEXO FROM FUNCIONARIOS
GROUP BY SEXO;
...
--LIMITANDO O RETORNO DO DATA SET
SELECT * FROM FUNCIONARIOS
LIMIT 10;

-- MOSTRANDO A SOMA E A MEDIA DE CADA DEPARTAMENTO
SELECT DEPARTAMENTO, SUM(SALARIO) AS "GASTO TOTAL", AVG(SALARIO) AS "GASTO MEDIO"
FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO;
...
CREATE TABLE MAQUINAS(
	MAQUINA VARCHAR(20),
	DIA INT,
	QTD NUMERIC(10,2) --FLOAT
);

COPY MAQUINAS
FROM "C:\SCRIPTS SQL DATA\LOGmAQUINAS.CSV"
DELIMITER ","
CSV HEADER;


--MEDIA COM ARRENDONDAMENTO
...
-- AMPLITUDE DE UM SET DE DADOS - METRICAS
--HISTOGRAMA
...
SELECT MAQUINA,
	ROUND(VAR_POP(QTD),2) AS VARIANCIA, --VARIÂNCIA
	ROUND(STDDEV_POP(QTD),2) AS DESVIO_PADRAO, --DESVIO PADRÃO
	ROUND((STDDEV_POP(QTD)/AVG(QTD))*100,2) AS COEFICIENTE_VARIACAO
...
-- MEDIANA -> IMPORTAR O CÓDIGO DO POSTGRESQL
